...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="col-xs-12" id="terms">
        ...
        <br/> <br/>
<div class="paragraf">SmartSet is a forum designed for computer science students.
<p>The following terms and conditions were put together to help users better understand how their use of this website will be governed. 
   </p>
...
<p class="tekst">When a user creates a topic, it is preferable that:</p>
      ...
      <li>-	The description covers in detail the problem. </li>
             ...
             <p class="tekst"> If the content of the topic is non-compliance with the above recommendations the topic will be removed by the admins.
                </p>
                 </li>
